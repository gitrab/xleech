...
loggedinorreturn();
    ...
    $HTMLOUT .= tr("Small Description", "<input type ='text' name='description' size='80' value='" .htmlspecialchars($row["description"]). "' /><br />Short description of the file you are uploading (I.E. Great action movie from the 90's)<br />This is shown in the browse below the torrent name.", 1);
